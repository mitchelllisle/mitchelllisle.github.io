...
I've built an [interactive dashboard](https://mitchelllisle.github.io/fires-nsw-dashboard/) that explores over 50 years of fire history in New South Wales—from 1970 to 2024. Using data from NSW's Department of Planning, Industry and Environment, it tells the story of where, when, and how fires have burned across the state.
...
Explore the dashboard at [mitchelllisle.github.io/fires-nsw-dashboard](https://mitchelllisle.github.io/fires-nsw-dashboard/) and see what patterns emerge from half a century of fire history.

---

*Explore the dashboard: [History of Bushfires in NSW](https://mitchelllisle.github.io/fires-nsw-dashboard/)*

*Data source: [NSW DPIE Fire History Dataset](https://datasets.seed.nsw.gov.au/dataset/fire-history-wildfires-and-prescribed-burns-1e8b6)*
