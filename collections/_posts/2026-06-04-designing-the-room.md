...
<div id="lewin-viz" style="font-family: Georgia, serif; max-width: 640px; margin: 2rem auto; padding: 2rem 1.5rem; color: var(--color-base-text); background: var(--color-base-bg); border: 1px solid var(--color-base-bg-3); border-radius: 4px;">
